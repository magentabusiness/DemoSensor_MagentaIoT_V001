...
public class TemperatureSetTransferPeriodResponse extends Message {



	public byte msgId = 0x04;						//Define the MessageId
	
	private String messageName = "TemperatureSetTransferPeriodResponse";	//Name of the Message
	...
	public TemperatureSetTransferPeriodResponse() {
		setType("deviceReq");
		setMessageId(msgId);
		setName(messageName);
	}
